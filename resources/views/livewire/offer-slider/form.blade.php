                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a wire:navigate href="{{ route('offer-slider.index') }}">Offer Slider</a></li>
                            ...
                            <div class="card-body">
                                <form wire:submit.prevent="save">
                                    ...
                                    <div class="d-flex justify-content-end gap-2">
                                        <a href="{{ route('offer-slider.index') }}" class="btn btn-secondary">Cancel</a>
