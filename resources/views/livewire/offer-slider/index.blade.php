                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li class="active">Offer Slider</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /# column -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="d-flex justify-content-between items-center mb-4">
                                ...
                                <a href="{{ route('offer-slider.create') }}" class="btn btn-primary">
                                    Create Offer Slider
                                </a>
                            </div>
                                        ...
                                        @forelse($galleries as $gallery)
                                            <tr>
                                                ...
                                                <td class="flex space-x-2">
                                                    <a href="{{ route('offer-slider.edit', $gallery) }}" class="btn btn-sm btn-primary">Edit</a>
