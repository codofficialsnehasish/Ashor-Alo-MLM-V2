                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a wire:navigate href="{{ route('certificates.index') }}">Certificates</a></li>
                                <li class="breadcrumb-item active">{{ $certificate  ->exists ? 'Edit' : 'Create' }}</li>
                            </ol>
                        </div>
                    </div>
                </div>
