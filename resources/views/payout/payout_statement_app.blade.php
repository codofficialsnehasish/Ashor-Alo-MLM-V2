...
<head>
    ...
    <title>Payout Statement | ASHOR ALO</title>
        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Payout Statement</h6>
                </div>
                <div class="card-body">
                            ...
                            <body>
                                <table style="width: 800px;">
                                    <tbody>
                                        <tr>
                                            <td align="center">
                                                <img src="https://ashoralo.in/public/site_data_images/1711967812cutlog.png" style="width: 100px;">
                                                <h1 style="margin: 0;font-size: 20px;">ASHOR ALO </h1>
                                                <h2 style="margin: 0;font-size: 16px;">Thacker House, 35, Chittaranjan Avenue, 4th Floor, Kolkata 700012, Near 5 No Gate Chandni Metro, West Bengal</h2>
                                                <p style="margin: 0;font-size: 14px;"><b>E-Mail :</b> ashoralo.in@gmail.com </p>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <tbody>
                                            ...
                                            <td>
                                                <table style="width: 800px;">
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <h2 style="margin: 0;font-size: 16px;margin-bottom: 5px;"><b>Name:</b> {{ $payout->user->name }}</h2>
                                                                <h2 style="margin: 0;font-size: 16px;"> <b>ID:</b> {{ $payout->user->member_number }} </h2>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
