...
<!-- Bar Chat Js -->
<script src="{{ asset('assets/js/lib/peitychart/jquery.peity.min.js') }}"></script><!-- scripit init-->
<script src="{{ asset('assets/js/lib/peitychart/peitychart.init.js') }}"></script><!-- scripit init-->
