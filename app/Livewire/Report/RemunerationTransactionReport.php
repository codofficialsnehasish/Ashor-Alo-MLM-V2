...
class RemunerationTransactionReport extends Component
{
    ...
    public $title = 'Remuneration Transaction Report';
    public $startDate;
    public $endDate;
    public $search = '';
    public $perPage = 10;
    ...
    protected function getQuery()
    {
        return AccountTransaction::query()
            ->whereIn('which_for', ['Salary Bonus'])
    ...
    {
        $this->checkPermission('Remuneration Transaction Report');
        if ($this->showFullReport) {
            return view('livewire.report.remuneration-transaction-full-report', [
        ...
        return view('livewire.report.remuneration-transaction-report', [
            'title' => $this->title,
