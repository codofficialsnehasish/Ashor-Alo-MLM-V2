...
namespace App\Livewire\WebApp\User\UserDashboard;
...
class RegisterMember extends Component
{
    ...
    public function mount()
    {
        ...
        $this->sponsor_id = auth()->user()->member_number;
    ...
    {
        return view('livewire.web-app.user.user-dashboard.register-member')
