...
namespace App\Livewire\OfferSlider;
...
class Form extends Component
{
    ...
    {
        $this->gallery = $gallery ? OfferSlider::findOrFail($gallery) : new OfferSlider();
    ...
    public function save()
    {
        ...
        return redirect(route('offer-slider.index'));

    }

    public function render()
    {
        return view('livewire.offer-slider.form');
    }
}
